...
accel_x_bp2 = bandpass(accel_x,[maxfreq_Y_accel - offset, maxfreq_Y_accel + offset],fs);
accel_x_bp = accel_x_bp1 + accel_x_bp2;
accel_y_bp1 = bandpass(accel_y,[maxfreq_Z_gyro - offset, maxfreq_Z_gyro + offset],fs);
accel_y_bp2 = bandpass(accel_y,[maxfreq_Y_accel - offset, maxfreq_Y_accel + offset],fs);
accel_y_bp = accel_y_bp1 + accel_y_bp2;
accel_z_bp1 = bandpass(accel_z,[maxfreq_Z_gyro - offset, maxfreq_Z_gyro + offset],fs);
accel_z_bp2 = bandpass(accel_z,[maxfreq_Y_accel - offset, maxfreq_Y_accel + offset],fs);
accel_z_bp = accel_z_bp1 + accel_z_bp2;
gyro_x_bp1 = bandpass(gyro_x,[maxfreq_Z_gyro - offset, maxfreq_Z_gyro + offset],fs);
gyro_x_bp2 = bandpass(gyro_x,[maxfreq_Y_accel - offset, maxfreq_Y_accel + offset],fs);
gyro_x_bp = gyro_x_bp1 + gyro_x_bp2;
gyro_y_bp1 = bandpass(gyro_y,[maxfreq_Z_gyro - offset, maxfreq_Z_gyro + offset],fs);
gyro_y_bp2 = bandpass(gyro_y,[maxfreq_Y_accel - offset, maxfreq_Y_accel + offset],fs);
gyro_y_bp = gyro_y_bp1 + gyro_y_bp2;
gyro_z_bp1 = bandpass(gyro_z,[maxfreq_Z_gyro - offset, maxfreq_Z_gyro + offset],fs);
gyro_z_bp2 = bandpass(gyro_z,[maxfreq_Y_accel - offset, maxfreq_Y_accel + offset],fs);
gyro_z_bp = gyro_z_bp1 + gyro_z_bp2;
yaw_bp1 = bandpass(yaw,[maxfreq_Z_gyro - offset, maxfreq_Z_gyro + offset],fs);
yaw_bp2 = bandpass(yaw,[maxfreq_Y_accel - offset, maxfreq_Y_accel + offset],fs);
yaw_bp = yaw_bp1 + yaw_bp2;
pitch_bp1 = bandpass(pitch,[maxfreq_Z_gyro - offset,maxfreq_Z_gyro + offset],fs);
pitch_bp2 = bandpass(pitch,[maxfreq_Y_accel - offset, maxfreq_Y_accel + offset],fs);
pitch_bp = pitch_bp1 + pitch_bp2;
roll_bp1 = bandpass(roll,[maxfreq_Z_gyro - offset, maxfreq_Z_gyro + offset],fs);
roll_bp2 = bandpass(roll,[maxfreq_Y_accel - offset, maxfreq_Y_accel + offset],fs);
roll_bp = roll_bp1 + roll_bp2;

% % bandpass second way
% offset = 0.01;
% accel_x_bp = lowpass(highpass(accel_x,maxfreq_Z_gyro,fs),maxfreq_Y_accel,fs);
% accel_y_bp = lowpass(highpass(accel_y,maxfreq_Z_gyro,fs),maxfreq_Y_accel,fs);
% accel_z_bp = lowpass(highpass(accel_z,maxfreq_Z_gyro,fs),maxfreq_Y_accel,fs);
% gyro_x_bp = lowpass(highpass(gyro_x,maxfreq_Z_gyro,fs),maxfreq_Y_accel,fs);
% gyro_y_bp = lowpass(highpass(gyro_y,maxfreq_Z_gyro ,fs),maxfreq_Y_accel,fs);
% gyro_z_bp = lowpass(highpass(gyro_z,maxfreq_Z_gyro,fs),maxfreq_Y_accel,fs);
% yaw_bp = lowpass(highpass(yaw,maxfreq_Z_gyro,fs),maxfreq_Y_accel,fs);
% pitch_bp = lowpass(highpass(pitch,maxfreq_Z_gyro,fs),maxfreq_Y_accel,fs);
% roll_bp = lowpass(highpass(roll,maxfreq_Z_gyro, fs),maxfreq_Y_accel,fs);
