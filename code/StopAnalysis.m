...
maxfreq_X_gyro = abs(f_gyro(X_gyro_I(3)));
maxfreq_X_gyro_mag = X_gyro_sorted(3);
...
% bandpass second way
offset = 0.01;
accel_x_bp = bandpass(accel_x,[maxfreq_X_gyro - offset, maxfreq_X_gyro + offset],fs);
accel_y_bp = bandpass(accel_y,[maxfreq_X_gyro - offset, maxfreq_X_gyro + offset],fs);
accel_z_bp = bandpass(accel_z,[maxfreq_X_gyro - offset, maxfreq_X_gyro + offset],fs);
gyro_x_bp = bandpass(gyro_x,[maxfreq_X_gyro - offset, maxfreq_X_gyro + offset],fs);
gyro_y_bp = bandpass(gyro_y,[maxfreq_X_gyro - offset, maxfreq_X_gyro + offset] ,fs);
gyro_z_bp = bandpass(gyro_z,[maxfreq_X_gyro - offset, maxfreq_X_gyro + offset],fs);
yaw_bp = bandpass(yaw,[maxfreq_X_gyro - offset, maxfreq_X_gyro + offset],fs);
pitch_bp = bandpass(pitch,[maxfreq_X_gyro - offset, maxfreq_X_gyro + offset],fs);
roll_bp = bandpass(roll,[maxfreq_X_gyro - offset, maxfreq_X_gyro + offset], fs);
...
% major frequency component at max y accel and z accel and third max x gyro
